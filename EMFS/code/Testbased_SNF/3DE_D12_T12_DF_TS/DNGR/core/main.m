...
dataD1 = dataD11.Wd;
% dataP1 = load('../../data/proteinsim1network.txt');
% dataP2 = load('../../data/proteinsim2network.txt');
% dataP3 = load('../../data/proteinsim3network.txt');
% dataP4 = load('../../data/proteinsim4network.txt');
